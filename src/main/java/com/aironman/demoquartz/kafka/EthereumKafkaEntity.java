...
// TODO refactor this class with BitCoinEuroKafkaEntity
public class EthereumKafkaEntity {
    ...
    public EthereumKafkaEntity() {
    }

    public EthereumKafkaEntity(String id, String name, String symbol, String rank, String priceUsd, String priceBtc, String _24hVolumeUsd, String marketCapUsd, String availableSupply, String totalSupply, String maxSupply, String percentChange1h, String percentChange24h, String percentChange7d, String lastUpdated, String priceEur, String _24hVolumeEur, String marketCapEur) {
        this.id = id;
        this.name = name;
        this.symbol = symbol;
        this.rank = rank;

...
@Entity
@Table(name="BitcoinEuroEntity")
public class BitcoinEuroEntity {

	@Id
    @GeneratedValue(strategy=GenerationType.IDENTITY)
    @Column(name = "idBCEntity", updatable = false, nullable = false)
    private Long idBCEntity;
	...
	@NotEmpty
    @Size(min = 1, max = 15)
    @Column(name = "maxSupply", updatable = true, nullable = false)
	...
	public BitcoinEuroEntity() {
		super();
	}

	public BitcoinEuroEntity(String id, String name, String symbol, String rank, String priceUsd, String priceBtc,
	...
	public Long getIdBCEntity() {
		return idBCEntity;
	}

	public void setIdBCEntity(Long idBCEntity) {
		this.idBCEntity = idBCEntity;
	}
	...
	public String toString() {
		return "BitcoinEuroEntity [idBCEntity=" + idBCEntity + ", id=" + id + ", name=" + name + ", symbol=" + symbol
